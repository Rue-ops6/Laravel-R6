...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-5">
  <a class="navbar-brand" href="#">Cars Website</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <a class="dropdown-item" href="testimonials.php">All testimonials</a>
          <a class="dropdown-item" href="InsertTestimonials.php">Insert testimonials</a>
          <a class="dropdown-item" href="UpdateTestimonials.php">Up-2-date testimonials</a>
        </div>
      </li>
    </ul>
  </div>
